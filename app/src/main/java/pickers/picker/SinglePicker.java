...
import pickers.listeners.OnSingleWheelListener;
import pickers.util.ConvertUtils;
...
public class SinglePicker<T> extends WheelPicker {
    ...
    public void setOnItemPickListener(pickers.listeners.OnItemPickListener listener) {
