...
public class ReceiverEditActivity extends Activity {
    ...
    private Button btn_savereceiver;
    private String str_name;
    private String str_phone;
    private String str_addr;
    private String str_addrdetail;
    private  String id;
    private static final String URL_NEWSENDER = URL_HEAD+"/send/receiver/edit";
    ...
    private void initView() {
        ...
        btn_savereceiver = findViewById(R.id.btn_savereceiver);
        Bundle bundle = getIntent().getExtras();
        ArrayList<String> list = bundle.getStringArrayList("receiver");
    ...
    private void initEvent() {
        btn_savereceiver.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onAddressPicker(View view) {
        ...
        task.setCallback(new AddressPickTask.Callback() {
            ...
            public void onAddressInitFailed() {
                Toast.makeText(ReceiverEditActivity.this,"数据初始化失败",Toast.LENGTH_SHORT).show();
            }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_NEWSENDER,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (code.equals("0")){
                                Toast.makeText(ReceiverEditActivity.this,"保存成功",Toast.LENGTH_SHORT).show();
                                new Handler(new Handler.Callback() {
                                    @Override
                                    public boolean handleMessage(@NonNull Message msg) {
                                        Intent intent =new Intent(ReceiverEditActivity.this, ReceiverListActivity.class);
                                        startActivity(intent);
                                        return false;
                                    }
                                }).sendEmptyMessageDelayed(0x123,2000);//延时2秒关闭
                            }else{
                                Toast.makeText(ReceiverEditActivity.this,"保存失败，"+msg,Toast.LENGTH_SHORT).show();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ReceiverEditActivity.this,"连接服务器失败，请检查网络连接",Toast.LENGTH_SHORT).show();
                    }
                }){
            @Override
            protected Map<String, String> getParams() {
                ...
                map.put("rec_name",str_name);
                map.put("rec_phone",str_phone);
                map.put("rec_addr",str_addr);
                map.put("rec_detail",str_addrdetail);
                return map;
            }
        };
