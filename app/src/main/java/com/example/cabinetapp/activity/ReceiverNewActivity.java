...
public class ReceiverNewActivity extends Activity {
    ...
    private static final String URL_NEWSENDER = URL_HEAD+"/send/receiver/new";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_receiver_new);
        initView();
        initEvent();
    }
    ...
    public void onAddressPicker(View view) {
        ...
        task.setCallback(new AddressPickTask.Callback() {
            ...
            public void onAddressInitFailed() {
                Toast.makeText(ReceiverNewActivity.this,"数据初始化失败",Toast.LENGTH_SHORT).show();
            }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_NEWSENDER,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (code.equals("0")){
                                Toast.makeText(ReceiverNewActivity.this,"保存成功",Toast.LENGTH_SHORT).show();
                                new Handler(new Handler.Callback() {
                                    @Override
                                    public boolean handleMessage(@NonNull Message msg) {
                                        Intent intent =new Intent(ReceiverNewActivity.this, ReceiverListActivity.class);
                                        startActivity(intent);
                                        return false;
                                    }
                                }).sendEmptyMessageDelayed(0x123,2000);//延时2秒关闭
                            }else{
                                Toast.makeText(ReceiverNewActivity.this,"保存失败，"+msg,Toast.LENGTH_SHORT).show();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ReceiverNewActivity.this,"连接服务器失败，请检查网络连接",Toast.LENGTH_SHORT).show();
                    }
                }){
            @Override
